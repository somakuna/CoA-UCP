...
<head>
    ...
    <title>{{ config('app.name', 'CoA UCP') }}</title>
    ...
    <link href="https://fonts.bunny.net/css?family=alexandria" rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <img src="/img/favicon.ico" height="20" alt="CoA">  {{ config('app.name', 'CoA UCP') }}
                </a>
